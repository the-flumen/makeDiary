...
def set_29 (yearNum, month2, path, hoilydae_list) : 
    ...
    start_slide_index = 692;
    start_link_slid_index = 1807;

    keyword = "주간재정"
    
    page_config = [
        {"type": "yearly", "targetPage": 3, "repeat": 1, "source_slide_index" : 0, "link_page_num" : 150},
        {"type": "daily", "targetPage": 150, "repeat": 366, "source_slide_index" : 97, "link_page_num" : 150, "month_link_page_num" : 15, "week_link_page_num" : 97},
        {"type": "monthly", "targetPage": 657, "repeat": 12, "source_slide_index" : 0, "link_page_num" : 150},
    ...
    daily_week_config = [
        ...
        {"type": "일기장", "startPage": 1058, "start_slide_index" : 1058},
        {"type": "감정일기", "startPage": 1424, "start_slide_index" : start_slide_index},
